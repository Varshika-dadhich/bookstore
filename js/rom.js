...
function loadUsers(){
    ...
    xhr.open('GET','https://www.googleapis.com/books/v1/volumes?q=romance',true);
...
var output='<div class="user00"> ' +'<div class="user"> ' +'  <p>' + '<b>'+ users.items[3].volumeInfo.title + '</b>' +  '</p>  ' + '<img src=" ' +  users.items[3].volumeInfo.imageLinks.smallThumbnail +'" height="400px" width="200px" >'+'</div>'+'<div class="para">'+'<p>'+'AUTHOR :' + users.items[3].volumeInfo.authors +  '</p>  ' + 'DESCRIPTION :' + '<p>' + users.items[3].volumeInfo.description +  '</p>  '+'</div>'+'</div>'
document.getElementById('users3').innerHTML=output;

var output='<div class="user00"> ' +'<div class="user"> ' +'  <p>' + '<b>'+ users.items[4].volumeInfo.title +  '</b>' + '</p>  ' + '<img src=" ' +  users.items[6].volumeInfo.imageLinks.smallThumbnail +'" height="400px" width="200px" >'+'</div>'+'<div class="para">'+'<p>'+'AUTHOR :' + users.items[4].volumeInfo.authors +  '</p>  ' + 'DESCRIPTION :' + '<p>' + users.items[4].volumeInfo.description +  '</p>  '+'</div>'+'</div>'
